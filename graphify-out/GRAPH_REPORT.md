...
## Corpus Check
- 82 files · ~411,811 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2634 nodes · 11345 edges · 31 communities detected
...
Cohesion: 0.02
Nodes (136): App, algebra_comp_checker(), algebra_compare_checker(), algebra_compare_output_checker(), algebra_complete_square_checker(), algebra_expand_checker(), algebra_inverse_checker(), algebra_rewrite_checker() (+128 more)
...
Cohesion: 0.03
Nodes (110): add_poly(), as_int64(), is_square_i64(), is_zero(), mul_poly(), poly_of(), r_add(), r_div() (+102 more)
...
Cohesion: 0.04
Nodes (8): Enum, RunState, TestStatus, HarnessLlmStatusTests, run_cli(), RuntimeSourceGuardTests, SharedCoreRegressionTests, TransformRegressionTests
...
Cohesion: 0.3
Nodes (15): convert_abs_pipes(), is_alpha_char(), is_digit_char(), is_name_char(), is_name_start(), normalize_compact_function_words(), normalize_function_pipe_calls(), normalize_inverse_trig_notation() (+7 more)

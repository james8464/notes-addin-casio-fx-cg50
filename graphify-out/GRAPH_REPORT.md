...
Cohesion: 0.03
Nodes (146): angle_to_degree(), apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), build_named_power_product() (+138 more)
...
Cohesion: 0.1
Nodes (101): add(), angle_reduction_transforms(), build_known_trig_value_branches(), build_named_power_term(), collect_same_arg_terms(), derive_cot_quadratic_expr(), direct_identity_target_rewrite(), equation_line() (+93 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (91): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), classify_solve_angle_arg(), compact_lines(), concise_root_text(), constant_numeric() (+83 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (75): cancel_fraction_common_factor_for_display(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), direct_double_angle_rewrite(), display_abs(), display_neg(), divide_terms_by_two_for_display() (+67 more)

### Community 9 - "Community 9"
Cohesion: 0.1
Nodes (60): add_param_coeff_maps(), add_transform_constant_candidate(), allowed_expression_from_terms(), build_known_value_branch(), build_rewrite_allowed_info(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any() (+52 more)
...
Cohesion: 0.12
Nodes (53): bridge_to_target(), detail_trig_expansion(), direct_expression_transform_lines(), direct_ratio_target_rewrite(), direct_single_trig_info(), domain_restriction_identity_lines(), equivalent(), _equivalent_uncached() (+45 more)
...
Cohesion: 0.26
Nodes (12): addq(), branch_target_value(), divq(), exact_pi_multiple(), factor_map(), int_pow(), match_numeric_multiple_arg(), maybe_scalar_times_var() (+4 more)

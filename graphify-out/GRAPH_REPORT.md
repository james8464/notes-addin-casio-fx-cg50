...
## Corpus Check
- 25 files · ~187,374 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1984 nodes · 9270 edges · 21 communities detected
...
Cohesion: 0.03
Nodes (168): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), best_solve_rewrite(), build_menu_pages(), classify_solve_angle_arg(), collect_angle_units() (+160 more)
...
Cohesion: 0.07
Nodes (79): cache_store(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), direct_double_angle_rewrite(), display_abs(), divq(), _enforce_total_cache_limit() (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (70): allowed_expression_from_terms(), build_rewrite_allowed_info(), direct_identity_target_rewrite(), direct_ratio_target_rewrite(), domain_restriction_identity_lines(), equation_has_trig_content(), expand_embedded_small(), expand_fraction() (+62 more)
...
Cohesion: 0.09
Nodes (45): _balance_parens(), begin_user_action(), best_proof_direction(), clean_expr_text(), collect_symbol_order(), collect_symbols(), collect_trig_argument_lower_symbols(), compact_lines() (+37 more)

### Community 11 - "Community 11"
Cohesion: 0.16
Nodes (35): bridge_to_target(), cancel_fraction_common_factor_for_display(), detail_trig_expansion(), equivalent(), finish_verbose_proof(), finish_verbose_proof_structured(), half_sum_diff_args(), match_generic_shift_side() (+27 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (35): addq(), angle_to_degree(), degree_int(), degree_mod_360(), exact_num_value(), exact_pi_multiple(), exact_trig_lines(), exact_trig_value() (+27 more)

### Community 13 - "Community 13"
Cohesion: 0.15
Nodes (33): add_param_coeff_maps(), add_transform_constant_candidate(), build_named_power_product(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any(), extract_linear_param_expr(), extract_template_allowed_terms_raw() (+25 more)

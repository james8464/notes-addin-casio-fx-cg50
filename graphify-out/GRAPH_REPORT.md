...
## Summary
- 1856 nodes · 8546 edges · 18 communities detected
...
Cohesion: 0.03
Nodes (147): angle_to_degree(), append_unique_value_node(), apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), build_menu_pages() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.1
Nodes (120): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), depends() (+112 more)
...
Cohesion: 0.07
Nodes (90): angle_text(), append_unique_float(), append_unique_solve_value(), compact_lines(), concise_root_text(), constant_numeric(), dedupe_values(), direct_single_trig_info() (+82 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (89): addq(), allowed_expression_from_terms(), build_named_power_product(), cheap_same(), classify_reciprocal_conjugate_binomial(), combine_fraction_sum_once(), direct_double_angle_rewrite(), direct_identity_target_rewrite() (+81 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (61): bridge_to_target(), cancel_fraction_common_factor_for_display(), common_denominator_step(), detail_trig_expansion(), direct_expression_transform_lines(), direct_ratio_target_rewrite(), equivalent(), _equivalent_uncached() (+53 more)
...
Cohesion: 0.11
Nodes (41): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), collect_symbol_order(), collect_trig_argument_lower_symbols(), constant_fit_preserve_named_trig(), depends_any(), detect_template_params() (+33 more)
...
Cohesion: 0.27
Nodes (10): display_abs(), display_neg(), make_display_mul(), match_reciprocal_minus_base_proof(), needs_div_brackets(), ordered_sum_text(), pr(), prove_reciprocal_reduction_identity() (+2 more)

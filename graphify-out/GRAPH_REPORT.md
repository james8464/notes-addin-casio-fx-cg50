...
Cohesion: 0.04
Nodes (117): apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), clean_expr_text(), clear_engine_caches() (+109 more)

### Community 4 - "Community 4"
Cohesion: 0.1
Nodes (121): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), depends() (+113 more)
...
Cohesion: 0.05
Nodes (105): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), classify_solve_angle_arg(), collect_solve_angle_units(), collect_symbols(), concise_root_text() (+97 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (67): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), cache_store(), cancel_fraction_common_factor_for_display(), collect_symbol_order(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (60): bridge_to_target(), common_denominator_step(), detail_trig_expansion(), direct_ratio_target_rewrite(), direct_single_trig_info(), domain_restriction_identity_lines(), equivalent(), _equivalent_uncached() (+52 more)
...
Cohesion: 0.09
Nodes (50): allowed_expression_from_terms(), build_named_power_product(), cheap_same(), classify_reciprocal_conjugate_binomial(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), divq(), extract_binomial() (+42 more)
...
Cohesion: 0.16
Nodes (21): addq(), angle_to_degree(), collect_angle_units(), degree_int(), degree_mod_360(), exact_pi_multiple(), exact_trig_lines(), exact_trig_value() (+13 more)

...
Cohesion: 0.03
Nodes (101): angle_to_degree(), append_unique_value_node(), apply_runtime_profile(), best_proof_direction(), build_menu_pages(), classify_solve_angle_arg(), clean_expr_text(), clear_engine_caches() (+93 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (109): add(), addq(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms() (+101 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (96): allowed_expression_from_terms(), bridge_to_target(), build_named_power_product(), cheap_same(), classify_reciprocal_conjugate_binomial(), combine_fraction_sum_once(), common_denominator_step(), detail_trig_expansion() (+88 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (80): angle_text(), append_unique_float(), append_unique_solve_value(), concise_root_text(), constant_numeric(), dedupe_values(), estimate_numeric_scan_samples(), estimate_solve_periods() (+72 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (74): add_transform_constant_candidate(), best_solve_rewrite(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), equation_has_trig_content(), expand_embedded_small(), expand_fraction(), expand_product() (+66 more)
...
Cohesion: 0.11
Nodes (41): _balance_parens(), begin_user_action(), compact_lines(), direct_expression_transform_lines(), direct_ratio_target_rewrite(), display_target_text(), domain_restriction_identity_lines(), equivalent() (+33 more)

### Community 13 - "Community 13"
Cohesion: 0.11
Nodes (33): cache_store(), depends(), direct_single_trig_info(), _enforce_total_cache_limit(), extract_polynomial_symbol(), extract_polynomial_trig(), extract_quadratic_trig(), factor_common_term_for_proof() (+25 more)

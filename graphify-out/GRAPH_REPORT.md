...
## Corpus Check
- 32 files · ~345,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2274 nodes · 10036 edges · 26 communities detected
...
Cohesion: 0.03
Nodes (162): addq(), angle_to_degree(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), cache_store() (+154 more)
...
Cohesion: 0.06
Nodes (130): allowed_expression_from_terms(), angle_reduction_transforms(), bridge_to_target(), build_named_power_product(), cancel_fraction_common_factor_for_display(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step() (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (108): add(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), collect_trig_argument_lower_symbols(), depends() (+100 more)
...
Cohesion: 0.06
Nodes (88): angle_text(), append_unique_float(), append_unique_solve_value(), compact_lines(), concise_root_text(), dedupe_values(), drop_trailing_solution_line(), estimate_numeric_scan_samples() (+80 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (67): add_param_coeff_maps(), add_transform_constant_candidate(), append_identity_difference_working(), append_unique_value_node(), build_rewrite_allowed_info(), collect_symbol_order(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+59 more)
...
Cohesion: 0.12
Nodes (27): half_angle_expr(), _is_cos_squared_term(), is_lowercase_symbol_name(), _is_sin_squared_term(), make_add(), match_cos_squared_term(), match_cot_squared_fraction(), match_linear_cot_const() (+19 more)

...
## Corpus Check
- 14 files · ~183,965 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1512 nodes · 7685 edges · 15 communities detected
...
Cohesion: 0.03
Nodes (69): App, Enum, algebra_comp_checker(), algebra_compare_checker(), algebra_compare_output_checker(), algebra_complete_square_checker(), algebra_expand_checker(), algebra_inverse_checker() (+61 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (109): allowed_expression_from_terms(), apply_runtime_profile(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), cache_store(), classify_solve_angle_arg(), clean_expr_text() (+101 more)
...
Cohesion: 0.12
Nodes (86): add(), angle_reduction_transforms(), collect_same_arg_terms(), derive_cot_quadratic_expr(), divide_terms_by_two_for_display(), equation_line(), exact_constant_candidates(), exact_first_quadrant() (+78 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (77): addq(), angle_to_degree(), build_named_power_product(), build_named_power_term(), degree_int(), degree_mod_360(), depends(), direct_single_trig_info() (+69 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (77): angle_text(), append_unique_float(), append_unique_solve_value(), concise_root_text(), constant_numeric(), dedupe_values(), estimate_solve_periods(), eval_numeric() (+69 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (60): cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), display_abs(), display_neg(), extract_binomial() (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (51): bridge_to_target(), detail_trig_expansion(), direct_ratio_target_rewrite(), equivalent(), _equivalent_uncached(), expand_safe_trig_tree(), expand_small(), finish_verbose_proof() (+43 more)

### Community 11 - "Community 11"
Cohesion: 0.12
Nodes (43): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any(), div() (+35 more)
...
- **Why does `sim()` connect `Community 6` to `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `num()` connect `Community 7` to `Community 3`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`?**

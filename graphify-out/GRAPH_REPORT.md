...
Cohesion: 0.03
Nodes (123): append_unique_value_node(), _balance_parens(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), build_named_power_product(), build_named_power_term(), cache_store() (+115 more)
...
Cohesion: 0.07
Nodes (109): allowed_expression_from_terms(), bridge_to_target(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), detail_trig_expansion(), direct_double_angle_rewrite(), direct_identity_target_rewrite() (+101 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (103): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), collect_same_arg_terms(), derive_cot_quadratic_expr(), display_target_text() (+95 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (72): angle_text(), append_unique_float(), append_unique_solve_value(), classify_solve_angle_arg(), compact_lines(), concise_root_text(), dedupe_values(), depends() (+64 more)
...
Cohesion: 0.08
Nodes (56): addq(), angle_to_degree(), combine_fraction_sum_once(), degree_int(), degree_mod_360(), display_abs(), divq(), exact_num_value() (+48 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (53): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), collect_symbol_order(), collect_trig_argument_lower_symbols(), constant_fit_preserve_named_trig(), depends_any() (+45 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (49): begin_user_action(), collect_symbols(), constant_numeric(), detect_transform_var(), direct_single_trig_info(), equation_has_trig_content(), _equivalent_uncached(), exact_angle_node_text() (+41 more)

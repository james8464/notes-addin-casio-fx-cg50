...
## Corpus Check
- 32 files · ~346,822 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2311 nodes · 10271 edges · 26 communities detected
...
Cohesion: 0.02
Nodes (405): add(), add_term_texts(), addq(), algebra_factor_text(), algebra_mode_3_lines(), algebra_mode_3_text(), algebra_mode_6_lines(), algebra_mode_6_text() (+397 more)
...
Cohesion: 0.05
Nodes (156): abs_term(), add(), addq(), all_neg_add(), _answer_text(), apply_runtime_profile(), as_rat(), as_rat_display() (+148 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (151): addq(), angle_to_degree(), append_unique_value_node(), _balance_parens(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), cache_store() (+143 more)
...
Cohesion: 0.06
Nodes (123): allowed_expression_from_terms(), build_named_power_product(), cancel_fraction_common_factor_for_display(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), depends(), direct_double_angle_rewrite() (+115 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (94): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), derive_cot_quadratic_expr() (+86 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (90): angle_text(), append_unique_float(), append_unique_solve_value(), concise_root_text(), constant_numeric(), dedupe_values(), default_no_interval_span(), direct_single_trig_info() (+82 more)
...
Cohesion: 0.07
Nodes (81): append_identity_difference_working(), begin_user_action(), bridge_to_target(), clean_expr_text(), compact_lines(), detail_trig_expansion(), detect_transform_var(), direct_expression_transform_lines() (+73 more)
...
Cohesion: 0.11
Nodes (45): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), collect_symbol_order(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any(), detect_template_params() (+37 more)

...
## Corpus Check
- 27 files · ~198,848 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1990 nodes · 9281 edges · 22 communities detected
...
Cohesion: 0.03
Nodes (115): best_proof_direction(), best_solve_rewrite(), build_menu_pages(), build_named_power_product(), clean_expr_text(), collect_angle_units(), collect_solve_angle_units(), collect_symbol_order() (+107 more)
...
Cohesion: 0.07
Nodes (85): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), classify_solve_angle_arg(), concise_root_text(), dedupe_values(), depends() (+77 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (83): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), derive_cot_quadratic_expr() (+75 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (82): add_param_coeff_maps(), add_transform_constant_candidate(), allowed_expression_from_terms(), build_rewrite_allowed_info(), cache_store(), cancel_fraction_common_factor_for_display(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+74 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (82): addq(), cheap_same(), classify_reciprocal_conjugate_binomial(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), direct_single_trig_info(), display_neg(), divide_terms_by_two_for_display() (+74 more)

### Community 10 - "Community 10"
Cohesion: 0.12
Nodes (60): angle_to_degree(), bridge_to_target(), common_denominator_step(), degree_int(), degree_mod_360(), detail_trig_expansion(), display_abs(), div() (+52 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (58): _balance_parens(), begin_user_action(), compact_lines(), constant_numeric(), detect_transform_var(), direct_expression_transform_lines(), drop_trailing_solution_line(), equation_has_trig_content() (+50 more)

...
Cohesion: 0.04
Nodes (102): apply_runtime_profile(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), cache_store(), classify_solve_angle_arg(), clean_expr_text(), clear_engine_caches() (+94 more)
...
Cohesion: 0.07
Nodes (103): allowed_expression_from_terms(), build_named_power_product(), cancel_fraction_common_factor_for_display(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), direct_double_angle_rewrite(), direct_identity_target_rewrite() (+95 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (93): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), concise_root_text(), constant_numeric(), dedupe_values(), detect_general_solution() (+85 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (60): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), collect_symbol_order(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any(), detect_template_params() (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (52): _balance_parens(), begin_user_action(), compact_lines(), detect_transform_var(), direct_expression_transform_lines(), direct_ratio_target_rewrite(), display_target_text(), drop_trailing_solution_line() (+44 more)
...
Cohesion: 0.14
Nodes (38): angle_to_degree(), bridge_to_target(), degree_int(), degree_mod_360(), detail_trig_expansion(), exact_trig_lines(), exact_trig_value(), expand_fraction() (+30 more)

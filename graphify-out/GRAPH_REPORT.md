...
## Corpus Check
- 25 files · ~183,749 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1882 nodes · 8607 edges · 20 communities detected
...
Cohesion: 0.03
Nodes (164): apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), cache_store(), classify_reciprocal_conjugate_binomial() (+156 more)
...
Cohesion: 0.06
Nodes (101): allowed_expression_from_terms(), build_named_power_product(), cheap_same(), depends(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), direct_single_trig_info(), display_abs() (+93 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (67): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), concise_root_text(), dedupe_values(), detect_general_solution(), direct_trig_family_line() (+59 more)
...
Cohesion: 0.1
Nodes (52): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), collect_symbol_order(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any() (+44 more)

### Community 11 - "Community 11"
Cohesion: 0.1
Nodes (52): angle_to_degree(), bridge_to_target(), common_denominator_step(), degree_int(), degree_mod_360(), detail_trig_expansion(), equivalent(), exact_trig_lines() (+44 more)

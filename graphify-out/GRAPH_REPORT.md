...
## Corpus Check
- 32 files · ~342,368 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2250 nodes · 9923 edges · 27 communities detected
...
Cohesion: 0.03
Nodes (145): addq(), angle_to_degree(), _balance_parens(), begin_user_action(), best_proof_direction(), build_menu_pages(), cache_store(), clean_expr_text() (+137 more)
...
Cohesion: 0.06
Nodes (105): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), classify_solve_angle_arg(), compact_lines(), concise_root_text(), constant_numeric() (+97 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (89): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), derive_cot_quadratic_expr() (+81 more)
...
Cohesion: 0.08
Nodes (78): build_named_power_product(), cheap_same(), classify_reciprocal_conjugate_binomial(), combine_fraction_sum_once(), common_denominator_step(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), display_abs() (+70 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (76): add_transform_constant_candidate(), allowed_expression_from_terms(), append_identity_difference_working(), best_solve_rewrite(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), direct_expression_transform_lines(), equation_has_trig_content() (+68 more)
...
Cohesion: 0.14
Nodes (51): bridge_to_target(), detail_trig_expansion(), div(), equivalent(), finish_verbose_proof(), half_angle_expand(), half_sum_diff_args(), match_plus_minus_pair() (+43 more)
...
Cohesion: 0.14
Nodes (34): add_param_coeff_maps(), collect_symbol_order(), collect_trig_argument_lower_symbols(), constant_fit_preserve_named_trig(), depends_any(), detect_template_params(), detect_transform_var(), extract_linear_param_expr() (+26 more)

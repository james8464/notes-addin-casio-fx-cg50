...
Cohesion: 0.03
Nodes (167): append_unique_value_node(), apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), cache_store() (+159 more)
...
Cohesion: 0.07
Nodes (102): addq(), allowed_expression_from_terms(), angle_to_degree(), build_named_power_product(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), direct_single_trig_info(), display_abs() (+94 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (98): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_named_power_term(), collect_same_arg_terms(), depends(), derive_cot_quadratic_expr() (+90 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (73): add_param_coeff_maps(), add_transform_constant_candidate(), build_known_value_branch(), build_rewrite_allowed_info(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), constant_numeric(), depends_any() (+65 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (58): angle_text(), append_unique_float(), append_unique_solve_value(), concise_root_text(), dedupe_values(), eval_numeric_mode(), exact_angle_node_text(), exact_angle_value_node() (+50 more)

### Community 10 - "Community 10"
Cohesion: 0.12
Nodes (49): bridge_to_target(), cancel_fraction_common_factor_for_display(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), detail_trig_expansion(), equivalent(), finish_verbose_proof() (+41 more)
...
Cohesion: 0.29
Nodes (11): is_lowercase_symbol_name(), match_cot_squared_fraction(), match_one_pm_cos(), match_one_pm_cos_norm(), match_scaled_div(), match_tan_squared_fraction(), rewrite_allowed_only(), rewrite_burden() (+3 more)

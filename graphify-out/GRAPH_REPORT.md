...
## Corpus Check
- 15 files · ~323,650 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1591 nodes · 8101 edges · 15 communities detected
...
- `split_num_factor()` --calls--> `cache_store()`  [EXTRACTED]
  src/Math/trigProgram.py → src/Math/trigProgram.py  _Bridges community 10 → community 9_
- `sim()` --calls--> `cache_store()`  [EXTRACTED]
  src/Math/trigProgram.py → src/Math/trigProgram.py  _Bridges community 10 → community 7_
...
Cohesion: 0.05
Nodes (106): apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite(), clean_expr_text(), clear_engine_caches(), collect_symbol_order() (+98 more)
...
Cohesion: 0.08
Nodes (99): bridge_to_target(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), detail_trig_expansion(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), direct_ratio_target_rewrite() (+91 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (98): add(), angle_reduction_transforms(), collect_same_arg_terms(), derive_cot_quadratic_expr(), div(), divide_terms_by_two_for_display(), equation_line(), exact_base_solution_nodes() (+90 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (87): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), classify_solve_angle_arg(), concise_root_text(), dedupe_values(), depends() (+79 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (64): addq(), angle_to_degree(), build_named_power_product(), build_named_power_term(), direct_single_trig_info(), display_abs(), display_neg(), divq() (+56 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (60): add_param_coeff_maps(), add_transform_constant_candidate(), allowed_expression_from_terms(), build_rewrite_allowed_info(), cache_store(), cancel_fraction_common_factor_for_display(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+52 more)
...
- **Why does `sim()` connect `Community 7` to `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `num()` connect `Community 9` to `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 10`?**

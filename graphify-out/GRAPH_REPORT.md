...
## Corpus Check
- 32 files · ~351,018 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2343 nodes · 10507 edges · 27 communities detected
...
Cohesion: 0.02
Nodes (425): add(), add_term_texts(), addq(), algebra_factor_text(), algebra_mode_3_lines(), algebra_mode_3_text(), algebra_mode_6_lines(), algebra_mode_6_text() (+417 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (300): add(), addq(), all_neg_add(), apply_runtime_profile(), auto_integral_routes(), auto_route_cyclic_parts(), auto_route_division(), auto_route_parts() (+292 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (104): App, algebra_comp_checker(), algebra_compare_checker(), algebra_compare_output_checker(), algebra_complete_square_checker(), algebra_expand_checker(), algebra_inverse_checker(), algebra_rewrite_checker() (+96 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (170): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), apply_runtime_profile(), _balance_parens(), best_solve_rewrite(), build_menu_pages() (+162 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (157): abs_term(), add(), addq(), all_neg_add(), _answer_text(), apply_runtime_profile(), as_rat(), as_rat_display() (+149 more)
...
Cohesion: 0.06
Nodes (94): allowed_expression_from_terms(), build_named_power_product(), build_rewrite_allowed_info(), cheap_same(), classify_reciprocal_conjugate_binomial(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), direct_single_trig_info() (+86 more)
...
Cohesion: 0.1
Nodes (64): append_identity_difference_working(), bridge_to_target(), common_denominator_step(), detail_trig_expansion(), direct_ratio_target_rewrite(), equivalent(), expand_safe_trig_tree(), expand_small() (+56 more)
...
Cohesion: 0.1
Nodes (54): add_param_coeff_maps(), add_transform_constant_candidate(), cancel_fraction_common_factor_for_display(), collect_symbol_order(), collect_trig_argument_lower_symbols(), combine_fraction_sum_once(), constant_fit_preserve_named_trig(), depends_any() (+46 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (43): begin_user_action(), best_proof_direction(), clean_expr_text(), collect_symbols(), compact_lines(), compact_working_lines(), display_target_text(), domain_restriction_identity_lines() (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (31): cache_store(), _enforce_total_cache_limit(), factor_common_term_for_proof(), factorisation_transforms(), function_names_of(), _function_names_uncached(), kind_names_of(), _kind_names_uncached() (+23 more)
...
## Knowledge Gaps
- **182 isolated node(s):** `Store one cache value and trim gently when the small-device limit is hit.`, `Keep a group of independent caches under one shared memory budget.`, `Clear regular caches and nested per-name cache dictionaries.`, `Prefix non-empty working lines with 1., 2., 3. for calculator display.`, `Build a simple numbered block and make sure the final line says Answer.` (+177 more)
...
- **Why does `CASIOApp` connect `Community 2` to `Community 6`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `LLMManager` connect `Community 6` to `Community 2`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `TransformRegressionTests` connect `Community 6` to `Community 2`?**

...
## Corpus Check
- 22 files · ~185,852 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1855 nodes · 8547 edges · 18 communities detected
...
Cohesion: 0.04
Nodes (142): angle_text(), append_unique_float(), append_unique_solve_value(), append_unique_value_node(), apply_runtime_profile(), best_solve_rewrite(), build_menu_pages(), classify_solve_angle_arg() (+134 more)
...
Cohesion: 0.08
Nodes (79): add_param_coeff_maps(), add_transform_constant_candidate(), allowed_expression_from_terms(), build_named_power_product(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (76): cache_store(), depends(), direct_single_trig_info(), _enforce_total_cache_limit(), equation_has_trig_content(), _equivalent_uncached(), extract_polynomial_symbol(), extract_polynomial_trig() (+68 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (72): bridge_to_target(), cheap_same(), classify_reciprocal_conjugate_binomial(), common_denominator_step(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), display_abs(), display_neg() (+64 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (49): _balance_parens(), begin_user_action(), best_proof_direction(), clean_expr_text(), collect_symbols(), collect_trig_argument_lower_symbols(), display_target_text(), domain_restriction_identity_lines() (+41 more)
...
Cohesion: 0.12
Nodes (26): addq(), angle_to_degree(), collect_angle_units(), degree_int(), degree_mod_360(), divq(), exact_pi_multiple(), exact_trig_lines() (+18 more)

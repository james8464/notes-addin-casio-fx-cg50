...
## Corpus Check
- 128 files · ~405,454 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2759 nodes · 11625 edges · 39 communities detected
...
Cohesion: 0.06
Nodes (56): abs_int(), add_input_line(), append_fraction(), append_fraction_poly(), append_fraction_value(), append_linear(), append_poly(), append_power() (+48 more)
...
- **Thin community `Community 35`** (2 nodes): `check_g3a_size.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `check_regressions.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `promote_failures.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `summarize_failures.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

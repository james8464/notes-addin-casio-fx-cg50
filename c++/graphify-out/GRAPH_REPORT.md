...
## Corpus Check
- 105 files · ~402,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2801 nodes · 11731 edges · 38 communities detected
...
Cohesion: 0.04
Nodes (94): abs_int(), add_input_line(), append_fraction(), append_fraction_poly(), append_fraction_value(), append_linear(), append_poly(), append_power() (+86 more)

...
const catalogFunc completeCat[] = { // list of all functions (including some not in any category)
  ...
  {"bool_simplify(expr)", 0, "Simplify a Boolean/logical expression. Required: expr.", "not(A and B) or A", 0, CAT_CATEGORY_ALGEBRA | (CAT_CATEGORY_PROGCMD << 8)},
  ...
  {"nand(a,b)", 0, "Boolean NAND: not(a and b). Required: a,b.", "A,B", 0, CAT_CATEGORY_ALGEBRA | (CAT_CATEGORY_PROGCMD << 8)},
  {"nor(a,b)", 0, "Boolean NOR: not(a or b). Required: a,b.", "A,B", 0, CAT_CATEGORY_ALGEBRA | (CAT_CATEGORY_PROGCMD << 8)},

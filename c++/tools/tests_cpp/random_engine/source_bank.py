...
SOURCE_FAMILIES: tuple[SourceFamily, ...] = (
    ...
    SourceFamily("source_edexcel_parametric_first", "derive", "diff", "x(t),y(t),t,method", "param", "Pearson Edexcel parametric calculus", "https://qualifications.pearson.com/en/qualifications/edexcel-a-levels/mathematics-2017/useful-links.html", ("dxdt_dydt", "dy_dx"), "markscheme markers: dx/dt, dy/dt, dy/dx"),
...
def _source_expr(fam: SourceFamily, rng: random.Random, i: int) -> str:
    ...
    if fam.topic == "source_edexcel_parametric_first":
        return rng.choice(["x=t^2+1/t,y=t^2-1/t,t,method=param", "x=e^t*cos(t),y=e^t*sin(t),t,method=param"])

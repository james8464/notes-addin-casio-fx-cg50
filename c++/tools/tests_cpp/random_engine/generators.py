...
class AdversarialGenerator:
    ...
    def _exam_gap(self, index: int) -> AdversarialCase:
        ...
        cases = [
            ...
            (
                ...
                "param",
                ("dxdt_dydt", "dy_dx"),
                "exam: show dx/dt, dy/dt, then dy/dx",
            ),
            (
                "interval_trig",
                "trig",
    ...
    def _syllabus(self, index: int) -> AdversarialCase:
        ...
        cases = [
            ...
            ("pure_sequences", "alg", "series(sqrt((1+a*x)/(4-x)),x,0,3)", "binomial", "expr,var,point,order", "expand", ("sqrt_quotient", "symbolic_coefficient"), True),
            ...
            ("stats_sampling_data", "stats", "binom(8,0.5,4)", "probability", "n,p,k", "binomial", ("formula",), False),
            ...
            ("stats_hypothesis", "stats", "normalcdf(5,1.2,5.4,8)", "hypothesis", "mu,sigma,lo,hi", "normal_tail", ("standardise",), False),

...
Loads the legacy Ollama manager from _legacy_llm.py, then replaces its system prompt
...
from _legacy_llm import LLMManager as _BaseLLMManager, check_ollama_available, get_ollama_models
...
class LLMManager(_BaseLLMManager):
    pass


LLMManager.LLM_SYSTEM_PROMPT = LLM_SYSTEM_PROMPT

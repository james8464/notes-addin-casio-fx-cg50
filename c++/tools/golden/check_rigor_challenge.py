...
DIRECT: dict[int, tuple[list[str], str | None, list[str]]] = {
    ...
    6: ([str(HOST), "--derive", "t^2+1/t,t^2-1/t,t,method=param_second"], None, ["Err: invalid method"]),
    7: ([str(HOST), "--derive", "e^t*cos(t),e^t*sin(t),t,method=param_second"], None, ["Err: invalid method"]),
    8: ([str(HOST), "--derive", "log(t),t+1/t,t,method=param_second"], None, ["Err: invalid method"]),
    ...
    20: ([str(HOST), "--derive", "a*(theta-sin(theta)),a*(1-cos(theta)),theta,method=param_second"], None, ["Err: invalid method"]),
    ...
    103: ([str(HOST), "--derive", "t^3-3*t,t^2+1,t,method=param_second"], None, ["Err: invalid method"]),
    104: ([str(HOST), "--derive", "sec(t),tan(t),t,method=param_second"], None, ["Err: invalid method"]),
    ...
    113: ([str(HOST), "--derive", "cos(t)^3,sin(t)^3,t,method=param_second"], None, ["Err: invalid method"]),
}

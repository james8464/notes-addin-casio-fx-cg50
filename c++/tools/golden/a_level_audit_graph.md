...
graph TD
  ...
  Q --> Qt["latest complete: M3/M4 kinematics dynamics easier ODEs"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6244` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `284` covered, `178` still gap-listed for future manual audit.

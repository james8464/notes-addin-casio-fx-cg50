...
graph TD
  ...
  Q --> QRec["latest complete: recurrence relations Q1-Q73"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5965` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `235` covered, `227` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> QData["latest complete: data analysis"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6032` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `244` covered, `218` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: M1/M2 kinematics using calculus"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6152` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `268` covered, `194` still gap-listed for future manual audit.

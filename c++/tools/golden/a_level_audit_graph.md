...
graph TD
  ...
  Q --> QGOF["latest complete: goodness of fit"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6061` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `249` covered, `213` still gap-listed for future manual audit.

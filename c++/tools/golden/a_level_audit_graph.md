...
graph TD
  ...
  Q --> QProp["latest complete: proportion samples"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6106` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `258` covered, `204` still gap-listed for future manual audit.

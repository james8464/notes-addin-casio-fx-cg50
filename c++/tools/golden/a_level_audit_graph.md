...
graph TD
  ...
  Q --> Qt["latest complete: M3/M6 pendulum motion"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6276` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `289` covered, `173` still gap-listed for future manual audit.

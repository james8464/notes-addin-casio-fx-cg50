...
graph TD
  ...
  Q --> Qt["latest complete: M2 centre of mass"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6182` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `273` covered, `189` still gap-listed for future manual audit.

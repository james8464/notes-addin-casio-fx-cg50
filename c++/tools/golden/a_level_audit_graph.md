...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6224` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `280` covered, `182` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 work in vector form"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6331` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `299` covered, `163` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: M6 intrinsic coordinates"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6337` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `300` covered, `162` still gap-listed for future manual audit.

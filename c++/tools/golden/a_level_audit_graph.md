...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 rotational motion"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6318` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `296` covered, `166` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> QSketch["latest complete: quadratic sketching Q1-Q18"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5936` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `232` covered, `230` still gap-listed for future manual audit.

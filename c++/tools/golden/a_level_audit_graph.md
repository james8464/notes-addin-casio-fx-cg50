...
graph TD
  ...
  Q --> QPoisson["latest complete: poisson distribution"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6090` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `254` covered, `208` still gap-listed for future manual audit.

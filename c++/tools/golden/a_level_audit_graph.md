...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C1 Paper Q"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6486` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `315` covered, `147` still gap-listed for future manual audit.

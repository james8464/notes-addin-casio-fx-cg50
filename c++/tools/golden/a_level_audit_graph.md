...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C1 Paper L"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6454` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `312` covered, `150` still gap-listed for future manual audit.

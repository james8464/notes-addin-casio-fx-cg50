...
graph TD
  ...
  Q --> Qt["latest complete: M1 resultants"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6169` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `271` covered, `191` still gap-listed for future manual audit.

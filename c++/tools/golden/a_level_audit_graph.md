...
graph TD
  ...
  Q --> Qt["latest complete: M3 gravitation problems"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6239` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `283` covered, `179` still gap-listed for future manual audit.

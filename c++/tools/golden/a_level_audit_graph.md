...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C2 Paper R"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6589` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `324` covered, `138` still gap-listed for future manual audit.

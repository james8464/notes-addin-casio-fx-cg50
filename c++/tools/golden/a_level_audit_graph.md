...
graph TD
  ...
  Q --> QGeom["latest complete: geometric distribution"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6056` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `248` covered, `214` still gap-listed for future manual audit.

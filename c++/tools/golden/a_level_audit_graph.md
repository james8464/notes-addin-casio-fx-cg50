...
graph TD
  ...
  Q --> QSurd["latest complete: surds practice Q1-Q34"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5990` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `238` covered, `224` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> QDataExam["latest complete: data analysis exam questions"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6039` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `245` covered, `217` still gap-listed for future manual audit.

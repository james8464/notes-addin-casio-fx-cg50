...
graph TD
  ...
  Q --> QRecip["latest complete: reciprocal functions Q1-Q24"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5951` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `234` covered, `228` still gap-listed for future manual audit.

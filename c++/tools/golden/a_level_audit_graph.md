...
graph TD
  ...
  Q --> Qt["latest complete: M3/M4 relative motion"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6258` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `286` covered, `176` still gap-listed for future manual audit.

...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5915` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `229` covered, `233` still gap-listed for future manual audit.

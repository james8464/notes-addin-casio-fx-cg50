...
graph TD
  ...
  Q --> Qt["latest complete: M3/M6 advanced projectiles"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6273` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `288` covered, `174` still gap-listed for future manual audit.

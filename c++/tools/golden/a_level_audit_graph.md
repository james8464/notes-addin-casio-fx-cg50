...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C2 Paper F"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6532` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `319` covered, `143` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> QVector["latest complete: vector algebra introduction"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5996` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `239` covered, `223` still gap-listed for future manual audit.

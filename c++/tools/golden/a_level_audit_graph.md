...
graph TD
  ...
  Q --> Qt["latest complete: M1/M2 projectiles"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6165` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `270` covered, `192` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: M1 kinematic graphs"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6141` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `266` covered, `196` still gap-listed for future manual audit.

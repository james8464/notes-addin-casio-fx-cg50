...
graph TD
  ...
  Q --> Qt["latest complete: M3 centre of mass"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6235` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `282` covered, `180` still gap-listed for future manual audit.

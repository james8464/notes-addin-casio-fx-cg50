...
graph TD
  ...
  Q --> Qt["latest complete: M4/M5 moment of inertia calculations"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6282` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `290` covered, `172` still gap-listed for future manual audit.

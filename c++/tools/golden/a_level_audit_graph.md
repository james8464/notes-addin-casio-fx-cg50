...
graph TD
  ...
  Q --> Qt["latest complete: M2/M3 circular motion"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6203` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `276` covered, `186` still gap-listed for future manual audit.

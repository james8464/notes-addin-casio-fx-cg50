...
graph TD
  ...
  Q --> QNormVars["latest complete: normal variables"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6086` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `253` covered, `209` still gap-listed for future manual audit.

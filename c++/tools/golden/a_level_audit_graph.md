...
graph TD
  ...
  Q --> Qt["latest complete: M2/M4 frameworks multistructures"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6219` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `279` covered, `183` still gap-listed for future manual audit.

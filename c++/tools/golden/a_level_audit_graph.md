...
graph TD
  ...
  Q --> Qt["latest complete: M2 collisions"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6189` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `274` covered, `188` still gap-listed for future manual audit.

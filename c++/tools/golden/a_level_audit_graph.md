...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 vector differential equations"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6327` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `298` covered, `164` still gap-listed for future manual audit.

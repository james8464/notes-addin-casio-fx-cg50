...
graph TD
  ...
  Q --> Qt["latest complete: M2/M3 elastic strings springs"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6209` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `277` covered, `185` still gap-listed for future manual audit.

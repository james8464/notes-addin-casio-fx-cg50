...
graph TD
  ...
  Q --> Qt["latest complete: t distribution"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6116` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `261` covered, `201` still gap-listed for future manual audit.

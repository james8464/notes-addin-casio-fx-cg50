...
graph TD
  ...
  Q --> QBinom["latest complete: binomial distribution"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6003` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `240` covered, `222` still gap-listed for future manual audit.

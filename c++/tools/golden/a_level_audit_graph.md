...
graph TD
  ...
  Q --> QQuadExam["latest complete: quadratics exam Q1-Q101"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5944` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `233` covered, `229` still gap-listed for future manual audit.

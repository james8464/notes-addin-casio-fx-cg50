...
graph TD
  ...
  Q --> QComb["latest complete: combinations and permutations"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6010` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `241` covered, `221` still gap-listed for future manual audit.

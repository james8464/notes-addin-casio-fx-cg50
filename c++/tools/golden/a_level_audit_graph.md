...
graph TD
  ...
  Q --> Qt["latest complete: M3/M5 simple harmonic motion"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6265` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `287` covered, `175` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> QPDF["latest complete: probability density functions"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6100` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `256` covered, `206` still gap-listed for future manual audit.

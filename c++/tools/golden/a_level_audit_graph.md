...
graph TD
  ...
  Q --> QProbability["latest complete: probability"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6095` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `255` covered, `207` still gap-listed for future manual audit.

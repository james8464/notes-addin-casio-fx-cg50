...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 variable mass problems"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6323` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `297` covered, `165` still gap-listed for future manual audit.

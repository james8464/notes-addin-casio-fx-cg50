...
graph TD
  ...
  Q --> Qt["latest complete: M2 equilibrium of rigid bodies"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6196` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `275` covered, `187` still gap-listed for future manual audit.

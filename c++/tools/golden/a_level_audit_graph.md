...
graph TD
  ...
  Q --> QHTIntro["latest complete: hypothesis testing intro"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6070` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `250` covered, `212` still gap-listed for future manual audit.

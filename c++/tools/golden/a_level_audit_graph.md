...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 moments in vector form"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6296` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `293` covered, `169` still gap-listed for future manual audit.

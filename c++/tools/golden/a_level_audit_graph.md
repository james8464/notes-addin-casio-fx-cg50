...
graph TD
  ...
  Q --> QCont["latest complete: contingency tables"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6016` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `242` covered, `220` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: M6 motion on axisymmetric surfaces"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6340` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `301` covered, `161` still gap-listed for future manual audit.

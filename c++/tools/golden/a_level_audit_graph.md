...
graph TD
  ...
  Q --> QDistApprox["latest complete: distributional approximations"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6052` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `247` covered, `215` still gap-listed for future manual audit.

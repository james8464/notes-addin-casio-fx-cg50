...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 polar coordinates and central forces"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6303` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `294` covered, `168` still gap-listed for future manual audit.

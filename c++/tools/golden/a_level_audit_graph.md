...
graph TD
  ...
  Q --> Qt["latest complete: M1 equilibrium"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6136` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `265` covered, `197` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> QRect["latest complete: rectangular distribution"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6112` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `260` covered, `202` still gap-listed for future manual audit.

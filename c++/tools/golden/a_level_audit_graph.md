...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C1 Paper D"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6369` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `304` covered, `158` still gap-listed for future manual audit.

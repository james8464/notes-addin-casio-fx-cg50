...
graph TD
  ...
  Q --> Qt["latest complete: M1 connected particles"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6125` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `263` covered, `199` still gap-listed for future manual audit.

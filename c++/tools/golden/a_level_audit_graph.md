...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 rotational and translational motion"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6309` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `295` covered, `167` still gap-listed for future manual audit.

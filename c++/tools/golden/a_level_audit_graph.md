...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 harder ODEs"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6292` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `292` covered, `170` still gap-listed for future manual audit.

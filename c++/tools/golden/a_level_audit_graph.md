...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C2 Paper I"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6545` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `320` covered, `142` still gap-listed for future manual audit.

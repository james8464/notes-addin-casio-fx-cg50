...
graph TD
  ...
  Q --> QDRV["latest complete: discrete random variables"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6046` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `246` covered, `216` still gap-listed for future manual audit.

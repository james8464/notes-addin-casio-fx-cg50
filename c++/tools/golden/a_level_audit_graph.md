...
graph TD
  ...
  Q --> Qt["latest complete: M2 work and energy"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6229` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `281` covered, `181` still gap-listed for future manual audit.

...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `5903` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `227` covered, `235` still gap-listed for future manual audit.

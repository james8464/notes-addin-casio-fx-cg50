...
graph TD
  ...
  Q --> QCorr["latest complete: correlation and regression"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6024` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `243` covered, `219` still gap-listed for future manual audit.

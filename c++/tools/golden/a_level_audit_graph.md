...
graph TD
  ...
  Q --> QHTNorm["latest complete: hypothesis testing normal distribution"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6077` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `251` covered, `211` still gap-listed for future manual audit.

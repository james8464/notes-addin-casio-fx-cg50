...
graph TD
  ...
  Q --> Qt["latest complete: M1 kinematics"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6147` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `267` covered, `195` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: M1/M2 moments"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6157` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `269` covered, `193` still gap-listed for future manual audit.

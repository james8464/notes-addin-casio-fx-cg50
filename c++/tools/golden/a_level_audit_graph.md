...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C2 Paper T"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6608` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `326` covered, `136` still gap-listed for future manual audit.

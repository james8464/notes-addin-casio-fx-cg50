...
graph TD
  ...
  Q --> Qt["latest complete: M1 vectors applications"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6176` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `272` covered, `190` still gap-listed for future manual audit.

...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C2 Paper P"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6567` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `322` covered, `140` still gap-listed for future manual audit.

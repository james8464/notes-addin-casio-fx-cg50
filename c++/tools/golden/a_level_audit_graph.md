...
graph TD
  ...
  Q --> Qt["latest complete: IYGB C2 Paper A"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6509` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `317` covered, `145` still gap-listed for future manual audit.

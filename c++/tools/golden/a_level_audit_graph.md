...
graph TD
  ...
  Q --> QRelated["latest complete: related random variables"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6109` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `259` covered, `203` still gap-listed for future manual audit.

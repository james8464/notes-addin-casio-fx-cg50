...
graph TD
  ...
  Q --> QNormCalc["latest complete: normal distribution calculations"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6082` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `252` covered, `210` still gap-listed for future manual audit.

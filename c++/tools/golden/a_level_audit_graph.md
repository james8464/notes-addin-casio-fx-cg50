...
graph TD
  ...
  Q --> Qt["latest complete: M3/M4 oblique collisions"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6251` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `285` covered, `177` still gap-listed for future manual audit.

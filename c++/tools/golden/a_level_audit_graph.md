...
graph TD
  ...
  Q --> Qt["latest complete: M4/M6 equilibrium and potential energy"]
```
...
- `check_madasmaths_standard_question_corpus.py`: `4554` rows, `6287` manual cases, no failures.
- `check_madasmaths_download_coverage.py`: `462` downloaded MadAsMaths question PDFs, `291` covered, `171` still gap-listed for future manual audit.

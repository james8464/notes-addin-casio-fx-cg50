...
CASES: list[tuple[str, list[str], list[str]]] = [
    ...
    ("N10 tan multiple solve", ["--trig", "tan(4*x)-tan(2*x)=0,x,0,360,8,method=bounded"], ["tan(A)=tan(B)", "x = 0, 90, 180, 270"]),
    ...
    ("O4 exact integral", ["--int", "defint(3*x/(2+x-x^2),x,0,1)"], ["Partial fractions", "2/(x-2) + 1/(x+1)", "log(2)"]),

...
CASES: tuple[Case, ...] = (
    ...
    Case("shell_stats", "shell", "stats(1,2,3,4)", ("mean = sum x/n = 5/2",)),
    Case("shell_binom", "shell", "binom(4,1/2,2)", ("Answer: 3/8",)),
    Case("shell_matrix_det", "shell", "det2(1,2,3,4)", ("Answer: det = -2",)),
    Case("shell_vector_cross", "shell", "cross3(1,0,0,0,1,0)", ("Answer: (0,0,1)",)),
    ...
    Case("direct_stats", "stats", "1,2,3,4", ("mean = sum x/n = 5/2",)),
    Case("direct_suvat", "suvat", "s=10,u=0,v=?,a=2,t=5", ("Answer: v = 10",)),
    Case("unsupported_cartesian", "shell", "cartesian(x=t,y=t^2)", ("unsupported on CG50 route",), True, 1),

...
def main() -> int:
    ...
    require(source, 'draw_pixel_text(344, 4, "R", 2, 2, kWhite);', "R glyph")
    require(source, "static unsigned char glyph", "pixel glyph renderer")
    require(source, "draw_pixel_text", "pixel text")

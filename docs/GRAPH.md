...
Last updated: 2026-06-01 05:14 BST
...
graph TD
  ...
  Runner --> Strict["13,008/14,256 strict marker pass"]
  Strict --> Remaining["remaining strict clusters: integrate 639, algebra 560, derive 44, trig 5; 32 B hard headroom"]
```

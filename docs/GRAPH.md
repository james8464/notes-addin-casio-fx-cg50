...
Last updated: 2026-06-01 02:38 BST
...
graph TD
  ...
  G3A --> Size["2,097,136 bytes; 16 byte headroom"]
```
...
graph TD
  ...
  Work --> Solve["solve: guarded linear, integer-root quadratics with explicit root lines and negative-leading exam order, rational, dy/dx and dn/dt separable"]
...
graph TD
  ...
  Runner --> Strict["12,962/14,256 strict marker pass"]

...
Last updated: 2026-06-01 06:27 BST
...
graph TD
  ...
  G3A --> Size["2,097,064 bytes; 88 byte headroom"]
```
...
graph TD
  ...
  Runner --> Strict["13,025/14,256 strict marker pass"]
  Strict --> Remaining["remaining strict clusters: integrate 627, algebra 560, derive 39; 88 B hard headroom"]
```

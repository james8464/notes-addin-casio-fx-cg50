...
namespace giac {
  ...
  */
  ...
  gen sin2exp(const gen & e,GIAC_CONTEXT){
    gen a=expi(angletorad(e,contextptr),contextptr);
  ...
  gen tan2exp(const gen & e,GIAC_CONTEXT){
    gen a=pow(expi(angletorad(e,contextptr),contextptr),2);
  ...
  gen exp2sincos(const gen & e,GIAC_CONTEXT){
    ...
    return exp(a,contextptr)*gen(cos(radtoangle(b,contextptr),contextptr),sin(radtoangle(b,contextptr),contextptr));
  }
  ...
  static gen subst_derive(const gen & e,const gen & i,const gen & newi,bool quotesubst,GIAC_CONTEXT){
    if (series_flags(contextptr) & (1<<7))
      return symb_of(e,symb_equal(i,newi)); //symbolic(at_of,makesequence(e,symb_equal(i,newi)));
    vecteur v=*e._SYMBptr->feuille._VECTptr;
    int s=int(v.size());
    if ( (s==2) && (v[1]==i) ){
      vecteur l(*_lname(newi,contextptr)._VECTptr);
  ...
  gen _halftan(const gen & args,GIAC_CONTEXT){
    ...
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_halftan(res,contextptr));
    if (is_equal(args))
  ...
  gen inv_test_exp(const gen & e,GIAC_CONTEXT){
    if ( (e.type==_SYMB) && (e._SYMBptr->sommet==at_exp))
      return symb_exp(-e._SYMBptr->feuille);
  ...
  gen _hyp2exp(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_hyp2exp(res,contextptr));
    if (is_equal(args))
  ...
  gen _sincos(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_sincos(res,contextptr));
    if (is_equal(args))
  ...
  gen _trig2exp(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_trig2exp(res,contextptr));
    if (is_equal(args))
  ...
  gen _halftan_hyp2exp(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_halftan_hyp2exp(res,contextptr));
    if (is_equal(args))
  ...
  gen _asin2acos(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_asin2acos(res,contextptr));
    if (is_equal(args))
  ...
  gen _asin2atan(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_asin2atan(res,contextptr));
    if (is_equal(args))
  ...
  gen _acos2asin(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_acos2asin(res,contextptr));
    if (is_equal(args))
  ...
  gen _acos2atan(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_acos2atan(res,contextptr));
    if (is_equal(args))
  ...
  gen _atan2asin(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_atan2asin(res,contextptr));
    if (is_equal(args))
  ...
  gen _atan2acos(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_atan2acos(res,contextptr));
    if (is_equal(args))
  ...
  gen _atrig2ln(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_atrig2ln(res,contextptr));
    if (is_equal(args))
  ...
  static gen rewrite_strong_exp(const gen & g_orig,GIAC_CONTEXT){
	...
	continue;
      g=gdg;
      if (!i)
	res=res*expi(cst_pi*dg,contextptr);
      else {
  ...
  static void rlvar(const gen &e,vecteur & res,bool alg){
	...
	if (it->type==_SYMB) {
	  ...
	  if (it->_SYMBptr->sommet==at_pow) 
	    rlvar(symb_ln((*(it->_SYMBptr->feuille._VECTptr))[0]),res,alg);
	}
      }
    }
  }
  ...
  gen _pow2exp(const gen & e,GIAC_CONTEXT){
    ...
    if (is_algebraic_program(e,var,res))
      return symb_prog3(var,0,_pow2exp(res,contextptr));
	...
	swapgen(v[0],v[1]);
      /*
      if (v[0].type==_VECT)
	return gensizeerr(gettext("matrix/list power unsupported; use matpow"));
      */
	...
	if (is_strictly_positive(tmp,contextptr))
	  return exp(tmp1*_pow2exp(ln(tmp,contextptr),contextptr),contextptr)*symb_exp(v[1]*cst_ipi());
	else
  ...
  gen gammatofactorial(const gen & x,GIAC_CONTEXT){
	...
	return symbolic(at_factorial,v.front());
      if (v.size()>2 && v.back()==plus_one){
	v.pop_back();
	return symbolic(at_factorial,symb_plus(v));
      }
    }
    if (x.type==_VECT)
  ...
  gen _tsimplify(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_tsimplify(res,contextptr));
    if (is_equal(args))
  ...
  gen expln2trig(const gen & g,GIAC_CONTEXT){
	...
	if (s==at_exp)
	  return expln2trig(symb_exp(-ff),contextptr);
	if (s==at_prod)
	...
	if (s==at_pow)
      ...
      return gen(retmp,-imtmp)*inv(pow(retmp,2)+pow(imtmp,2),contextptr);
    }
...
#if 0
      gen gre,gim;
      reim(f,gre,gim,contextptr);
      gre=simplify(gre,contextptr);
      gim=simplify(gim,contextptr);
#else
  ...
  gen simplify(const gen & e_orig,GIAC_CONTEXT){
	...
	*logptr(contextptr) << vabs2tmp << endl;
    ...
    if (s1){
      gen g1(normal(trigcos(reg,contextptr),contextptr),normal(trigcos(img,contextptr),contextptr));
      gen g2(normal(trigsin(reg,contextptr),contextptr),normal(trigsin(img,contextptr),contextptr));
  ...
  gen _trigcos(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_trigcos(res,contextptr));
    if (is_equal(args))
  ...
  gen _trigsin(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_trigsin(res,contextptr));
    if (is_equal(args))
  ...
  gen _trigtan(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_trigtan(res,contextptr));
    if (is_equal(args))
  ...
  gen _tan2sincos(const gen & args,GIAC_CONTEXT){
    if ( args.type==_STRNG && args.subtype==-1) return  args;
     gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_tan2sincos(res,contextptr));
   if (is_equal(args))
  ...
  gen _sin2costan(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_sin2costan(res,contextptr));
    if (is_equal(args))
  ...
  gen _cos2sintan(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_cos2sintan(res,contextptr));
    if (is_equal(args))
  ...
  gen _tan2sincos2(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_tan2sincos2(res,contextptr));
    if (is_equal(args))
  ...
  gen _tan2cossin2(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_tan2cossin2(res,contextptr));
    if (is_equal(args))
  ...
  gen tcollect(const gen & args,bool output_cos,GIAC_CONTEXT){
	...
	if (output_cos){
	  gen angle(normal(arg(gen(coscoeff,sincoeff),contextptr),contextptr));// gen angle=normal(arg(coscoeff+cst_i*sincoeff,contextptr),contextptr);
	  res=res+newcoeff*symb_cos(argu-angle);
	}
	else {
	  gen angle(normal(arg(gen(sincoeff,coscoeff),contextptr),contextptr));//gen angle=normal(arg(sincoeff+cst_i*coscoeff,contextptr),contextptr);
	  res=res+newcoeff*symb_sin(argu+angle);
	}
      }
    }
    return res;
  ...
  gen _tcollect(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_tcollect(res,contextptr));
    if (is_equal(args))
  ...
  gen _tcollectsin(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_tcollectsin(res,contextptr));
    if (is_equal(args))
  ...
  static vecteur inlncollect(const gen & args,GIAC_CONTEXT){
    if (args.type!=_SYMB)
      return makevecteur(args,symb_exp(1));
  ...
  gen _lncollect(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_lncollect(res,contextptr));
    if (is_equal(args))
  ...
  gen _powexpand(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_powexpand(res,contextptr));
    if (is_equal(args))
  ...
  gen _exp2pow(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_exp2pow(res,contextptr));
    if (is_equal(args))
  ...
  gen _factor_xn(const gen & args,GIAC_CONTEXT){
    ...
    gen var,res;
    if (is_algebraic_program(args,var,res))
      return symb_prog3(var,0,_factor_xn(res,contextptr));
    if (is_equal(args))
  ...
  static gen rectangular2polar(const gen & g,const context * contextptr){
    ...
    if (is_zero(argument))
      return module;
    gen res=module*symb_exp(cst_i*argument);
...
#if 1
    gen reel,imag;
    reim(g,reel,imag,contextptr);
    return gen(reel,imag);
#else
    gen args(g);
  ...
  static gen rectangular2spherical(const gen & g,const context * contextptr){
    ...
    gen phi=arg(gen(x,y),contextptr); // arg(x+cst_i*y,contextptr);

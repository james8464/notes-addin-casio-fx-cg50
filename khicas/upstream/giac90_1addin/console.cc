...
#define remove_path0 remove_path
#ifndef GEN_PRINT_BUFSIZE
#define GEN_PRINT_BUFSIZE 512
#endif

int select_interpreter(){ return 0; }
int khicas_addins_menu(GIAC_CONTEXT){ return 0; }
...
const char * inputparam(char curname,int symbolic){
    ...
    strncpy(inputparam_result,s.c_str(),sizeof(inputparam_result)-1);
    inputparam_result[sizeof(inputparam_result)-1]=0;
    return inputparam_result;
}

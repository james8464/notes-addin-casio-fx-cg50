...
const catalogFunc completeCat[] = { // A-level scoped catalog only
  ...
  {"force(m,a)", "force(", "A-level Newton's second law with working.", "force(5,2)", 0, CAT_CATEGORY_PHYS | (CAT_CATEGORY_CALCULUS << 8)},
  {"friction(mu,R)", "friction(", "A-level limiting friction with working.", "friction(0.4,20)", 0, CAT_CATEGORY_PHYS | (CAT_CATEGORY_CALCULUS << 8)},
  ...
  {"moment(F,d)", "moment(", "A-level moment of a force with working.", "moment(12,0.5)", 0, CAT_CATEGORY_PHYS | (CAT_CATEGORY_CALCULUS << 8)},

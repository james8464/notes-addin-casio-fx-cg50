...
CASES = [
    ...
    ("suvat(s=10,u=2,a=3)", ["SUVAT", "s=10", "u=2", "v=[-8, 8]", "a=3", "t=[-10/3, 2]", "physical: t=2, v=8"]),
    ...
    ("suvat(d=10,start=2,acc=3)", ["SUVAT", "s=10", "u=2", "a=3", "physical: t=2, v=8"]),
    ("suvat(u=2,a=0,t=5)", ["SUVAT", "s=10", "u=2", "v=2", "a=0", "t=5"]),
    ("suvat(u=0,a=5,s=10)", ["SUVAT", "s=10", "u=0", "v=[-10, 10]", "a=5", "t=[-2, 2]", "physical: t=2, v=10"]),
    ("suvat(s=0,u=0,v=0)", ["SUVAT", "s=0", "u=0", "v=0", "Some values unresolved."], ["\na=0\n", "\nt=0\n"]),
    ...
    ("suvat(u=,a=3,t=4)", ["SUVAT", "a=3", "t=4", "Ignored input: u", "Need 3 named values."], ["\nu=\n", "Some values unresolved."]),
    ("suvat(u=2,a=0,v=2)", ["SUVAT", "u=2", "v=2", "a=0", "Some values unresolved."], ["s=2*t", "t=(-u + v)/a"]),
    ("suvat(s=0,u=5,v=-5)", ["SUVAT", "s=0", "u=5", "v=-5", "Some values unresolved."], ["a=-10/t", "t=2*s/(u + v)"]),

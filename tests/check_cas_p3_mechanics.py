...
CASES = [
    ...
    ("suvat(u=sin(pi/6),a=1,t=2)", ["SUVAT", "u=sin(pi/6)", "v=5/2", "s=3"]),
    ("suvat(s=10,u=2,a=3)", ["SUVAT", "s=10", "u=2", "v=[8, -8]", "a=3", "t=[2, -10/3]"]),
    ("suvat(s=10,v=8,a=3)", ["SUVAT", "s=10", "u=[-2, 2]", "v=8", "a=3", "t=[10/3, 2]"]),

...
WORLDS = [
    ...
    {"s": "25/2", "u": "5", "v": "0", "a": "-1", "t": "5"},
    {"s": "12*sqrt(2)", "u": "sqrt(2)", "v": "5*sqrt(2)", "a": "sqrt(2)", "t": "4"},
    {"s": "9/2", "u": "ln(e^2)", "v": "1", "a": "-1/3", "t": "3"},
]
...
EDGE_CASES = [
    ...
    "suvat(u=matrix([[1]]),a=3,t=4)",
    "suvat(u=normalcdf(0,1,2),a=3,t=4)",
    "suvat(u=plot(x),a=3,t=4)",
    "suvat(u=seq(k,k,1,3),a=3,t=4)",
    "suvat(u=piecewise(1,x<0,2),a=3,t=4)",
    "suvat(u=when(x>0,1,2),a=3,t=4)",
    "suvat(u=solve(x=1,x),a=3,t=4)",
    "suvat(u=sqrt(),a=3,t=4)",
    "suvat(u=sin(),a=3,t=4)",
    "suvat(u=ln(),a=3,t=4)",
    "suvat(u=1/0,a=3,t=4)",
    "suvat(u=undef,a=3,t=4)",
    "suvat(u=true,a=3,t=4)",
    "suvat(u=false,a=3,t=4)",
    "suvat(u=\"abc\",a=3,t=4)",
    "suvat(u=foo(bar),a=3,t=4)",
    "suvat(u=sum(k,k,1,3),a=3,t=4)",
    "suvat(d=10,start=2,acc=3)",
    "suvat(x=10,start=2,acc=3)",
    "suvat(u=sqrt(2),a=1,t=3)",
    "suvat(u=root(27,3),a=1,t=2)",
    "suvat(u=pi,a=0,t=2)",
    "suvat(u=p,a=q,t=r)",

...
def main():
    ...
    require("bool_simplify(A.(B+C))", ["2. B.A + C.A    (Expansion of brackets)", "50. B.A + C.A", "Result: B.A + C.A"])
    ...
    require("boolprove(A.(B+C),A.B+A.C)", ["3. Simplify LHS:", "36. Simplify RHS:", "70. RHS final: B.A + C.A"])

...
def main():
    ...
    require("A particle of mass 3 kg is on a rough plane angle 25 degrees, coefficient 0.4. It is projected up the plane at 8 m/s. Find how far it travels before rest.", ["Motion is up a rough inclined plane", "deceleration = g(sin(theta)+mu cos(theta))", "distance = u^2/(2*deceleration)"])

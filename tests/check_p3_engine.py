...
def main():
    ...
    require("A car of mass 1000 kg moving at 20 m/s has engine power 30 kW and resistance 500N find acceleration", ["Use P = Fv", "driving force = P/v = 30000/20 = 1500", "a = F/m = 1000/1000 = 1"])

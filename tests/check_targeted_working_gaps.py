...
CASES = [
    ("integrate(2*x+3,x)", ["Terms:", "Use int(a*x^n)", "x^2 + 3*x + C"]),
    ...
    ("integrate(x^-1,x,3)", ["Recip:", "x^-1 = 1/x", "Use int(1/x)", "ln(abs(x)) + C"]),
    ...
    ("range(-x^2+4*x+1)", ["vertex x = 2", "max y = 5", "y <= 5"]),
    ...
    ("range(x^2-4*x+5,x,0,5)", ["Interval: 0 <= x <= 5", "f(0) = 5", "f(5) = 10", "vertex x = 2 inside", "1 <= y <= 10"]),
    ("simplify((x^2+3*x+2)/(x+1))", ["Factor:", "x^2 + 3*x + 2 = (x + 1)*(x + 2)", "Cancel common factor (x + 1)", "x + 2"]),
    ...
    ("diff((((x)^-1)/(x))^2,x)", ["Chain rule:", "u = x^-1/x", "du/dx = ((-x^-2)*(x) - (x^-1))/(x)^2", "2*(x^-1/x)*(((-x^-2)*(x) - (x^-1))/(x)^2)"]),
    ...
    ("diff((sin(x))^3,x)", ["Chain rule:", "u = sin(x)", "du/dx = cos(x)", "3*(sin(x))^2*cos(x)"]),
    ...
    ("diff(ln((x+1)^2),x)", ["Chain rule:", "d/dx ln((x + 1)^2)", "u' = 2*(x + 1)", "2/(x + 1)"]),
    ("diff(sin((x+1)^2),x)", ["Chain rule:", "u = (x + 1)^2", "du/dx = 2*(x + 1)", "2*(x + 1)*cos((x + 1)^2)"]),
    ("diff(cos(3*x^2-2*x),x)", ["Chain rule:", "u = 3*x^2 - 2*x", "du/dx = 6*x - 2", "-(6*x - 2)*sin(3*x^2 - 2*x)"]),
    ("diff(exp((2*x-1)^3),x)", ["Chain rule:", "u = (2*x - 1)^3", "du/dx = 6*(2*x - 1)^2", "6*(2*x - 1)^2*exp((2*x - 1)^3)"]),
    ...
    ("integrate((x^2+2*x+1)/(x+1),x)", ["Simplify first:", "x^2 + 2*x + 1 = (x + 1)*(x + 1)", "Cancel common factor (x + 1)", "1/2*x^2 + x + C"]),
    ("integrate((x^2-1)/(x+1),x)", ["Simplify first:", "x^2 - 1 = (x + 1)*(x - 1)", "Cancel common factor (x + 1)", "1/2*x^2 - x + C"]),
    ...
    ("xform(-7,expand(-7))", ["-7"]),
    ("xform(x,factor(x))", ["x"]),
    ("xform(2*sin(x-60)=cos(x-30),tan(x)=3*sqrt(3))", ["Angle formulae:", "sin(x-a)=sin(x)*cos(a)-cos(x)*sin(a)", "cos(x-a)=cos(x)*cos(a)+sin(x)*sin(a)", "tan(x)=3*sqrt(3)"]),
    ("xform(2*sin(x-60)-cos(x-30)=0,tan(x)=3*sqrt(3))", ["Angle formulae:", "2sin(x-60)-cos(x-30) = 0", "tan(x)=3*sqrt(3)"]),

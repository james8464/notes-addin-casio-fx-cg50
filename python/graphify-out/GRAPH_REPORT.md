...
Cohesion: 0.03
Nodes (159): addq(), angle_to_degree(), append_unique_value_node(), apply_runtime_profile(), _balance_parens(), begin_user_action(), best_proof_direction(), best_solve_rewrite() (+151 more)
...
Cohesion: 0.1
Nodes (114): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), collect_trig_argument_lower_symbols() (+106 more)
...
Cohesion: 0.06
Nodes (100): angle_text(), append_unique_float(), append_unique_solve_value(), compact_lines(), concise_root_text(), constant_numeric(), dedupe_values(), depends() (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (89): add_param_coeff_maps(), add_transform_constant_candidate(), append_identity_difference_working(), build_rewrite_allowed_info(), cache_store(), cancel_fraction_common_factor_for_display(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+81 more)
...
Cohesion: 0.14
Nodes (21): collect_symbols(), display_abs(), display_neg(), domain_restriction_identity_lines(), extract_linear_combo_equation(), extract_shift_equation(), extract_shifted_linear_angle(), has_variable_dependency() (+13 more)

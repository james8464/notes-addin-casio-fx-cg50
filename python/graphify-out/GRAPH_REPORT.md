...
Cohesion: 0.03
Nodes (131): append_unique_value_node(), apply_runtime_profile(), best_proof_direction(), best_solve_rewrite(), build_menu_pages(), cache_store(), casio_hw_sim_from_env(), classify_solve_angle_arg() (+123 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (117): add(), angle_reduction_transforms(), branch_target_value(), build_known_trig_value_branches(), build_known_value_branch(), build_named_power_term(), collect_same_arg_terms(), depends() (+109 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (90): angle_text(), append_unique_float(), append_unique_solve_value(), concise_root_text(), constant_numeric(), dedupe_values(), direct_trig_family_line(), display_neg() (+82 more)
...
Cohesion: 0.07
Nodes (88): addq(), allowed_expression_from_terms(), angle_to_degree(), build_named_power_product(), cheap_same(), classify_reciprocal_conjugate_binomial(), combine_fraction_sum_once(), direct_double_angle_rewrite() (+80 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (79): _balance_parens(), begin_user_action(), collect_symbols(), compact_lines(), detect_transform_var(), direct_expression_transform_lines(), domain_restriction_identity_lines(), drop_trailing_solution_line() (+71 more)
...
Cohesion: 0.1
Nodes (57): append_identity_difference_working(), bridge_to_target(), common_denominator_step(), detail_trig_expansion(), expand_safe_trig_tree(), expand_small(), finish_verbose_proof(), _full_simplify_uncached() (+49 more)

### Community 14 - "Community 14"
Cohesion: 0.12
Nodes (34): add_param_coeff_maps(), add_transform_constant_candidate(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), collect_symbol_order(), collect_trig_argument_lower_symbols(), constant_fit_preserve_named_trig(), depends_any() (+26 more)

...
Cohesion: 0.03
Nodes (128): addq(), angle_to_degree(), apply_runtime_profile(), best_solve_rewrite(), build_menu_pages(), cache_store(), casio_hw_sim_from_env(), clean_expr_text() (+120 more)
...
Cohesion: 0.06
Nodes (76): _balance_parens(), begin_user_action(), best_proof_direction(), collect_symbols(), compact_lines(), detect_transform_var(), direct_expression_transform_lines(), domain_restriction_identity_lines() (+68 more)
...
Cohesion: 0.09
Nodes (67): cheap_same(), classify_reciprocal_conjugate_binomial(), direct_double_angle_rewrite(), direct_identity_target_rewrite(), direct_single_trig_info(), display_abs(), extract_binomial(), extract_quadratic_trig() (+59 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (67): angle_text(), append_unique_float(), append_unique_solve_value(), classify_solve_angle_arg(), concise_root_text(), dedupe_values(), depends(), eval_numeric() (+59 more)
...
Cohesion: 0.09
Nodes (59): add_param_coeff_maps(), add_transform_constant_candidate(), allowed_expression_from_terms(), build_named_power_product(), build_rewrite_allowed_info(), cancel_fraction_common_factor_for_display(), combine_fraction_sum_once(), constant_fit_preserve_named_trig() (+51 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (54): bridge_to_target(), common_denominator_step(), detail_trig_expansion(), direct_ratio_target_rewrite(), finish_verbose_proof(), finish_verbose_proof_structured(), format_rewrite_lines(), half_sum_diff_args() (+46 more)

### Community 15 - "Community 15"
Cohesion: 0.1
Nodes (48): append_identity_difference_working(), append_unique_value_node(), constant_numeric(), direct_trig_family_line(), exact_angle_node_text(), exact_angle_value_node(), exact_base_solution_nodes(), expand_embedded_small() (+40 more)
